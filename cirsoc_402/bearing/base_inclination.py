...
def base_inclination_factors(factors=DEFAULTBEARINGFACTORS):
...
def base_inclination_factor_c(factors=DEFAULTBEARINGFACTORS):
...
def base_inclination_factor_q(factors=DEFAULTBEARINGFACTORS):
...
def base_inclination_factor_g(factors=DEFAULTBEARINGFACTORS):
